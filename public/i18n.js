export const translations = {
  en: {
    ...
    adminPromote: "Promoted to admin",
    adminDemote: "Demoted to user",
    ...
    globalProviderTitle: "Global AI provider",
    globalProviderDesc: "When enabled, this provider overrides the .env default for everyone without an active personal key (BYOK). Users with their own enabled key are unaffected.",
    globalProviderToggle: "Enable global provider",
    globalProviderToggleHint: "Applies to all users and guests without an active personal key.",
    globalProviderSaved: "Global provider saved",
  ...
  id: {
    ...
    adminPromote: "Naik jadi admin",
    adminDemote: "Turun jadi user",
    ...
    globalProviderTitle: "Provider AI global",
    globalProviderDesc: "Saat diaktifkan, provider ini menggantikan default .env untuk semua pengguna tanpa key pribadi aktif (BYOK). Pengguna dengan key aktif mereka sendiri tidak terpengaruh.",
    globalProviderToggle: "Aktifkan provider global",
    globalProviderToggleHint: "Berlaku untuk semua pengguna dan tamu tanpa key pribadi aktif.",
    globalProviderSaved: "Provider global tersimpan",
